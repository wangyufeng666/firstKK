...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,url:'/idlefishv2/recyorder/pagelist'
...
function orderInfo(orderNo){
	layer.open({
		type:2,
		title:'订单详情',
		content:'/idlefishv2/recyorder/orderinfo?orderNo='+orderNo+'&layer=Y',
		shadeClose:false,
		shade:0.8,
		area:['100%' , '100%'],
...
function toPay(orderNo){
	layer.open({
		type:2,
		title:'订单详情',
		content:'/idlefishv2/recyorder/topay?orderNo='+orderNo+'&layer=Y',
		shadeClose:false,
		shade:0.8,
		area:['100%' , '100%'],
		close:function(index){
...
function downloadZhiMaExport(){
	...
	window.location.href = '/idlefishv2/recyorder/zhimaexport?'+param;
...
function downloadNumExport(){
	...
	param += '&startDate=' + $('#startDate').val();
	param += '&endDate=' + $('#endDate').val();
	window.location.href = '/idlefishv2/recyorder/numexport?'+param;
	return false; //截取返回false就不会保存网页了
}
...
function successEvaluationExport(){
	...
	param += '&startDate=' + $('#startDate').val();
	param += '&endDate=' + $('#endDate').val();
	window.location.href = '/idlefishv2/recyorder/successevaluationexport?'+param;
	return false; //截取返回false就不会保存网页了
}
...
function cancelReasonExport(){
	...
	param += '&startDate=' + $('#startDate').val();
	param += '&endDate=' + $('#endDate').val();
	window.location.href = '/idlefishv2/recyorder/cancelreasonexport?'+param;
	return false; //截取返回false就不会保存网页了
}

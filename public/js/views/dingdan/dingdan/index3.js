...
function orderInfo(orderId){
	window.location.href = "/dingdan/dingdan/orderinfo?backUrl=/dingdan/dingdan/orderindex3&orderId="+orderId;
}
...
function editOrder(orderId){
	window.location.href = "/dingdan/dingdan/editorder?os=3&backUrl=/dingdan/dingdan/orderindex3&orderId="+orderId;
}

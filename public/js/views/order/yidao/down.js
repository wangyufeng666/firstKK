...
function orderInfo(orderNo){
	window.location.href = "/order/yidao/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function sendCoupon(orderNo){
	window.location.href = "/order/yidao/sendcouponpage?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function downloadDiDaoExport(){
	...
	window.location.href = '/order/yidao/yidaoexport?'+param;

...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,url : '/lenovo/lenovostore/pagelist'
...
function orderInfo(orderNo){
	window.location.href = "/lenovo/lenovostore/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function sendCoupon(orderNo){
	window.location.href = "/lenovo/lenovostore/sendcouponpage?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function downloadDdExport(){
	...
	window.location.href = '/lenovo/lenovostore/lenovostoreexport?'+param;

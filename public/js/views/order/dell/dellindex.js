...
$().ready(function(){
  grid = $('#grid').grid({
    ...
    ,cm : [
      ...
      ,{header: "商品报价", dataIndex: 'INQMERPRICE', width:'70px',sortable:false}
      ,{header: "活动报价", dataIndex: 'INQSETTLEPRICE', width:'70px',sortable:false}
      ,{header: "检测报价", dataIndex: 'SBMERPRICE', width:'70px',sortable:false}
...
function orderInfo(orderNo){
	window.location.href = "/order/dell/dellorderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}

...
(function (factory) {
    ...
    Autocomplete.formatResult = function (suggestionValue, currentValue) {
        ...
        return suggestionValue.replace(new RegExp(pattern, 'gi'), '<≌>$1<\/≌>');
    };
    ...
    Autocomplete.prototype = {
        ...
        getSuggestionsLocal: function (query) {
            ...
            for(var i = 1; i<querys.length; i++){
            	if(querys[i].trim() !=''){
            		ss = {
                            suggestions: $.grep(ss.suggestions, function (option) {
                            	return filter(option, querys[i], querys[i]);
                            })
                        };
            	}
            }
        ...
        suggest: function () {
            ...
            $.each(that.suggestions, function (i, suggestion) {
                ...
                html += '<div class="' + className + '" data-index="' + i + '">' + formatValue + '</div>';
            });

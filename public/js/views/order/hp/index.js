...
function orderInfo(orderNo){
	window.location.href = "/order/hp/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function sendCoupon(orderNo){
	window.location.href = "/order/hp/sendcouponpage?orderNo="+orderNo+"&backUrl="+backUrl;
}

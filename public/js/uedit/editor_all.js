...
(function () {
    ...
    var Editor = UE.Editor = function( options ) {
        ...
        me.setOpt({
            ...
            iframeCssUrl: me.options.UEDITOR_HOME_URL + '../../js/uedit/themes/default/iframe.css',
...
//                img.style.cssText += ';margin:' + (first.margin||0) +"px;" + 'border:' + (first.border||0) +"px solid #000";
            ...
            if(opt.length == 1){
                ...
                html.push(str)
            	$('#uploader_container').append('<input  type="radio" checked="checked" name="jdt" value="'+ci.src+'"/><img onclick="checks(this)"  style="height: 60px; list-style: none; overflow: hidden; " src="'+ci.src+'">');
...
//                        }
                    ...
                    if(lj==""){
                		lj ='<input id="jdt'+i+'" type="radio" checked="checked" name="jdt" value="'+ci.src+'"/><img onclick="checks(this)" style="height: 60px; list-style: none; overflow: hidden; " src="'+ci.src+'">&nbsp;';
                	}else{
                		if(i%6==0){
                			lj = lj+'<input id="jdt'+i+'" type="radio" name="jdt" value="'+ci.src+'"/><img onclick="checks(this)" style="height: 60px; list-style: none; overflow: hidden; " src="'+ci.src+'">&nbsp;<BR>';
                		}else{
                			lj = lj+'<input id="jdt'+i+'" type="radio" name="jdt" value="'+ci.src+'"/><img onclick="checks(this)" style="height: 60px; list-style: none; overflow: hidden; " src="'+ci.src+'">&nbsp;';
                		}
                	}                    
                }
                
                $('#uploader_container').append(lj);
        ...
        if(opt.sourceEditor == "codemirror"){
            me.addListener("ready",function(){
                utils.loadFile(document,{
                    src : opt.codeMirrorJsUrl || opt.UEDITOR_HOME_URL + "../../js/uedit/third-party/codemirror2.15/codemirror.js",
                    tag : "script",
                ...
                utils.loadFile(document,{
                    ...
                    rel : "stylesheet",
                    type : "text/css",
                    href : opt.codeMirrorCssUrl || opt.UEDITOR_HOME_URL + "../../js/uedit/third-party/codemirror2.15/codemirror.css"
                });

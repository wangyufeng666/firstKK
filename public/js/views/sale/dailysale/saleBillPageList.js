...
function getParams(){
	return {
		...
		saler:$('#saler').val(),
		startSaleDate:$('#startSaleDate').val(),
		endSaleDate:$('#endSaleDate').val(),
...
function saleBillExport(){
	...
	var startSaleDate = $('#startSaleDate').val();
	...
	param += '&startSaleDate='+startSaleDate+'&endSaleDate='+endSaleDate+'&saler='+saler;

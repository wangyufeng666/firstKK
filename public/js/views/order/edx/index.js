...
function sendCoupon(orderNo){
	window.location.href = "/order/edx/sendcouponpage?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function downloadEdxExport(){
	...
	window.location.href = '/order/edx/edxexport?'+param;

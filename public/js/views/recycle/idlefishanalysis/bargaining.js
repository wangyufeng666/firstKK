...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,cm:[
			...
			,{header:"推送时间", dataIndex:'PUSHDATE', width:'80px',sortable:false}
		...
		,url:'/recycle/idlefishanalysis/bargapagelist'
...
function download(){
	var param = getParams();
	var params = 'startDate='+param.startDate+'&endDate='+param.endDate+'&merType='+param.merType+'&brandCode='+param.brandCode+'&channel='+param.channel+'&orderSource='+param.orderSource+'&flag=1';

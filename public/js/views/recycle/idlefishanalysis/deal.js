...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,cm:[
			...
			,{header:"下单时间", dataIndex:'CREATEDATE', width:'80px',sortable:false}
			,{header:"成交时间", dataIndex:'DEALDATE', width:'80px',sortable:false}
		...
		,url:'/recycle/idlefishanalysis/deallist'
...
function download(){
	var param = getParams();
	var params = 'startDate='+param.startDate+'&endDate='+param.endDate+'&merType='+param.merType+'&brandCode='+param.brandCode+'&channel='+param.channel+'&orderSource='+param.orderSource+'&flag=4';

...
function orderInfo(orderNo){
	window.location.href = "/order/xiangqi/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function sendCoupon(orderNo){
	window.location.href = "/order/xiangqi/sendcouponpage?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function exportCoupon(){
	...
	window.location.href = '/order/xiangqi/exportcoupon?'+param;

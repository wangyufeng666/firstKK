...
function orderInfo(orderNo){
	window.location.href = "/order/mtbmm/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function sendCoupon(orderNo){
	window.location.href = "/order/mtbmm/sendcouponpage?orderNo="+orderNo+"&backUrl="+backUrl;
}

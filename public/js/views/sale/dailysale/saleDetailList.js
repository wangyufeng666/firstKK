...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,url:'/sale/dailysale/detailpagelist'
...
function saleInfo(saleBillNo){
	...
	layer.open({
		...
		shadeClose:false,
		shade:0.8,
		content:'/sale/dailysale/salebillinfo?saleBillNo='+saleBillNo+'&orderNo='+orderNo+'#'+orderNo,
		area:['100%' , '100%'],
...
function saleDetailExport(){
	...
	window.location.href = '/sale/dailysale/exportdetaillist'+param;
}

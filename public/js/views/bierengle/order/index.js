        ...
        renderer : function(value, data, rowIndex, colIndex, metadata){
    	  ...
    	  if(orderType == '97'){
    	      if(status == '8'){
                  ...
                  returnText += ' | <a href="javascript:void(0);" onclick="sendCoupon(\''+orderNo+'\')" class="a_link">查看发券</a>';
              }
    	  }
          return returnText;
        }
...
function orderInfo(orderNo){
	window.location.href = "/bierengle/order/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}
...
function sendCoupon(orderNo){
	window.location.href = "/bierengle/order/sendcouponpage?orderNo="+orderNo+"&backUrl="+backUrl;
}

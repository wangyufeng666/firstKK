...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"imageup"                      //图片上传提交地址
        ,imagePath:URL + "uploads/template/"         //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,filePath:URL + "uploads/template/"         //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                   //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"imageup"   //处理远程图片抓取的地址
        ,catcherPath:URL + "uploads/template/"       //图片修正地址，同imagePath
        //,catchFieldName:"upfile"                   //提交到后台远程图片uri合集，若此处修改，需要在后台对应文件修改对应参数
        //,separater:'ue_separate_ue'                //提交至后台的远程图片地址字符串分隔符
        //,localDomain:[]                            //本地顶级域名，当开启远程图片抓取时，除此之外的所有其它域名下的图片都将被抓取到本地

        //图片在线管理配置区
   //   ,imageManagerUrl:URL + "uploads/template/imageManager.php"       //图片在线管理的处理地址
        ,imageManagerPath:URL + "uploads/template/"                        //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: URL +"imageup"     //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/uploads/template/snapImgUp.php"”
        ,snapscreenPath: URL + "uploads/template/"
        //,snapscreenServerPort: 80             //屏幕截图的server端端口
        //,snapscreenImgAlign: 'center'         //截图的图片默认的排版方式

        //word转存配置区
        //,wordImageUrl:URL + "uploads/template/imageUp.php"             //word转存提交地址
        ,wordImagePath:URL + "uploads/template/"                       //
        //,wordImageFieldName:"upfile"                        //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
    //    ,getMovieUrl:URL+"uploads/template/getMovie.php"    //视频数据获取地址
       ...
       // ]
        ,toolbars:[
                  ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                      ...
                      'directionalityltr', '|', '', 'indent', '|',
                      'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
                      'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright',
                      'imagecenter', '|', 'insertimage', 'highlightcode','pagebreak', '|',
                      'horizontal', '|',
...
//        ,labelMap:{
//            'anchor':'锚点', 'undo':'撤销', 'redo':'重做', 'bold':'加粗','insertimage':'图片'
//        }
    ...
    ,labelMap:{
        ...
        'RowSpacingTop':'段前距', 'RowSpacingBottom':'段后距','highlightcode':'插入代码', 'pagebreak':'分页', 'imagenone':'默认',

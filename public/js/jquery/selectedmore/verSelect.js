window.verSelector = (function () {
    ...
    var keyup_search = function () {
        ...
        if (text.length < 1) {
            ...
            for (var i in text) {
                ...
                _h += '<p title="'+value+'" data-value="' + value + '" class="verSelector-option-value verSelector-two ' + cl + '">' + icon + ' ' + text[i].innerText + '</p>'
            }
    ...
    var show_options = function (tar) {
        ...
        [].forEach.call(options,function (i) {
            ...
            if (value != '') {
                _h += '<p title="'+value+'" data-value="' + value + '" class="verSelector-option-value verSelector-two ' + cl + '">' + icon + ' ' + i.innerText + '</p>'
            }
        });
        ops.innerHTML = _h;
        _option(check);

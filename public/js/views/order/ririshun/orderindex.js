...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,cm:[
			...
			,{header:"订单来源", dataIndex:'ORDERTYPENAME', width:'140px',sortable:false}
...
function download(){
	...
	var params = 'merName='+merName+'&orderNo='+orderNo+'&tradeType='+tradeType+'&contactWay='+contactWay+'&orderStatus='+orderStatus+'&storeName='+storeName+'&payType='+payType;
		params += '&startDate='+startDate+'&endDate='+endDate+'&category='+category+'&merType='+merType+'&expressNum='+expressNum+'&address='+address+'&imei='+imei+'&source='+source;
	window.location.href='/order/ririshun/export?'+params;
}

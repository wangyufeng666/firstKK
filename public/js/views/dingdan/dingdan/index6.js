...
function orderInfo(orderId){
	window.location.href = "/dingdan/dingdan/orderinfo?backUrl=/dingdan/dingdan/orderindex6&orderId="+orderId;
}
...
function editOrder(orderId){
	window.location.href = "/dingdan/dingdan/editorder?os=6&backUrl=/dingdan/dingdan/orderindex6&orderId="+orderId;
}

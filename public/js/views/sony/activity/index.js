...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,cm:[
			...
			,{header:"操作", dataIndex:'ORDERNO', width:'60px', sortable:false, 
				renderer:function(value, data, rowIndex, colIndex, metadata){
		...
		,url:'/sony/sonyactivity/pagelist'
...
function orderInfo(orderNo){
	layer.open({
		...
		title:'回收订单详情',
		shadeClose:false,
		content:'/sony/sonyactivity/orderinfo?orderNo='+orderNo,
		area:['100%', '100%'],
...
function downloadOrder(){
	...
	window.location.href = '/sony/sonyactivity/orderexport?'+$.param(param);

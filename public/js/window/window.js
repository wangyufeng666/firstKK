...
if(top != this){
	 ...
	 * @param resizable 添加resizable控制, true为可以resizable
	 */	
	windowOpen = function(){
		var config = {};
		if(Ext.type(arguments[0]) == 'object'){
			...
			var resizable = arguments[0].resizable;
		}else{
		...
		win = new Ext.Window({
				...
				resizable:resizable === true? true:false,//是否可以改变大小,默认为false

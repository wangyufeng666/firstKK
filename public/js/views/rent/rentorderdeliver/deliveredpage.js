		...
		,cm : [
           ...
           ,{header: "操作", dataIndex: '', width:'15%', sortable:false, 
				renderer:function(value, data, rowIndex, colIndex, metadata){
                    ...
                    var returnText = '<a href="/rent/installment/deliverbill?orderNo='+data['ORDER_NO']+'" target="view_window" title="'+data['ORDER_NO']+'" class="a_link">出租清单</a>';
                    return returnText;
				}
			}       
		]
 ...
 */
function downOrder(){
    window.location.href = '/rent/rentorderdeliver/deliveredorderexport';

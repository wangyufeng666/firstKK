	...
	grid = $('#grid').grid({
		...
		,cm : [
           ...
           ,{header:"操作", dataIndex:'', width:'120px', sortable:false,
        	   renderer : function(value, data, rowIndex, colIndex, metadata){
					var returnText ='<a class="a_link" href="javascript:void(0);" onclick="storeOptMould(\''+data['PARTNERCODE']+'\')">红包模型分配</a>';
...
function storeOptMould(storeNo){
	var url = '/device/alipaycoupon/storeoptmould?storeNo='+storeNo;

...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,cm:[
           ...
           ,{header: "最近报价时间", dataIndex: 'CREATEDATE', width:'90px',sortable:false}
...
function doExport(){
	...
	var quoteFlag = 99;
    var param = 'merName='+merName+'&merType='+merType+'&pinpai='+pinpai+'&enableds='+enableds+'&merSource=1&timeFrame='+timeFrame+'&quoteFlag='+quoteFlag;

...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,cm :[
			...
			,{header:"入库时间",dataIndex:'INWAREDATE',width:'150px',sortable:false}			
		...
		,url:'/inventory/inventory/innumlist'
...
function doExport(){
	...
	window.location.href = "/inventory/inventory/innumexecl?"+encodeURI(param);
}

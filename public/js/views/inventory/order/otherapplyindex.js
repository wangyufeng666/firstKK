...
//		        	if(status == 3){
//		        		returnText +=' | <a class="a_link" href="javascript:void(0);" onclick="giveBack(\''+data['ORDERNO']+'\',\''+data['APPLYSOURCE']+'\')">归还</a>';
//		        	}
		    	  return returnText;
		        }
           	}
...
function orderInfo(orderNo){
	window.location.href = "/order/order/orderinfo?backUrl=/inventory/order/otherapplyindex&orderNo="+orderNo;
}

...
,{header: "推荐手机号", dataIndex: 'MAINMOBILE', width:'100px',sortable:false}
,{header: "被邀手机号", dataIndex: 'PASSIVEMOBILE', width:'100px',sortable:false}
,{header: "被邀订单编号", dataIndex: 'ORDERCODE',width:'120px',sortable:false}
,{header: "被邀订单金额", dataIndex: 'SETTLEPRICE',width:'80px',sortable:false}
,{header: "被邀订单状态", dataIndex: 'ORDERTYPE_TEXT',width:'80px',sortable:false}
,{header: "推荐获得佣金4%", dataIndex: 'RECOMMPRICE',width:'80px',sortable:false}
,{header: "活动码", dataIndex: 'INVITECODE',width:'80px',sortable:false}
...
,{header: "操作", dataIndex: '', width:'150px', sortable:false,
        ...
        ,url : '/yonghu/recommend/fanqipagelist'

...
function orderInfo(orderId){
	window.location.href = "/dingdan/dingdan/orderinfo?backUrl=/dingdan/dingdan/orderindex7&orderId="+orderId;
}
...
function editOrder(orderId){
	window.location.href = "/dingdan/dingdan/editorder?os=7&backUrl=/dingdan/dingdan/orderindex7&orderId="+orderId;
}

...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,url : '/recycle/orderoffline/pagelist'
	...
	$("#partnerCode").change(function(){
		...
		$.post('/recycle/orderoffline/getsources', {partnerCode:partnerCode}, function(data){
...
function orderInfo(orderNo){
	window.location.href = "/recycle/orderoffline/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
}

...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,url : '/analyze/orderwarn/pagelist'
...
var backUrl = '/analyze/orderwarn/index';
...
$('#exportlist').on('click',function(){
	...
	var param = '?merType='+merType+'&partnerCode='+partnerCode+'&orderSource='+orderSource+'&startDate='+startDate+'&dayNo='+dayNo+'&orderNo='+orderNo;
	window.location.href = '/analyze/orderwarn/exportlist'+param;
});

...
$().ready(function(){
	...
	$('#mersUl').delegate('.unApproval','click',function(e){
		stopEvent(e);
		var promoterId = $(this).attr('data-id');
		layer.open({
		    content: '<ul class="alter"><li class="alttop">提示</li><li class="altbody">是否确定审批？</li><ul>',
		    btn: ['确定','取消'],
		    shadeClose:false,
		    yes: function(index){
		    	window.location.href="/partner/promoter/approval?promoterId="+promoterId;
			},no:function(){
				layer.closeAll();
		    }
		});
	...
	$('#mersUl').delegate('.delect_obt','click',function(e){
		...
		layer.open({
		    ...
		    shadeClose:false,
		    yes: function(index){
		    	window.location.href="/partner/promoter/deletepromoter?promoterId="+promoterId;
			},no:function(){
				layer.closeAll();
		    }
		});
	...
	$('#mersUl').delegate('.oitop_box','click',function(){
		...
		window.location.href="/partner/promoter/orders?promoCode="+promoterCode;
	});
...
function doSeach(){
	...
	/*$.post('/partner/promoter/promoters',{keywords:keywords})*/
	window.location.href = '/partner/promoter/promoters?keywords='+keywords;
}

function addPromoter(){
	window.location.href = '/partner/promoter/addpromoter';
}

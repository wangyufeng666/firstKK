...
$().ready(function(){
	grid = $('#grid').grid({
		...
		,url:'/idlefishv2/recyorder/returnbacklist'
...
function orderInfo(orderNo){
	window.location.href = "/idlefishv2/recyorder/orderinfo?orderNo="+orderNo+"&backUrl="+backUrl;
...
function toPay(orderNo){
	window.location.href = "/idlefishv2/recyorder/topay?orderNo="+orderNo+"&backUrl="+backUrl;
}

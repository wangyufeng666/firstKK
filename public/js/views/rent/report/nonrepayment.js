var backUrl = '/rent/report/nonrepayment';
var grid;
var layerIndex = 0;
$().ready(function(){
	grid = $('#grid').grid({
		...
		,cm:[
			...
			,{header: "订单时间", dataIndex: 'CREATEDATE', width:'10%',sortable:false}
		...
		,url : '/rent/report/nonrepaymentpage'
...
$('#exportlist').on('click',function(){
	var days = $('#days').val();
	var param = '?days='+days;
	window.location.href = '/rent/report/nonrepaymentexport'+param;
});

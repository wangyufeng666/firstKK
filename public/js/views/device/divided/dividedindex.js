...
function strategyInfo(strategyCode){
	window.location.href = "/device/divided/dividedinfo?strategyCode="+strategyCode+"&backUri="+backUri;
}
...
function editstrategy(strategyCode){
	$.layer({
		type:2,
		title:'修改策略信息',
		iframe:{src:'/device/divided/editstrategyinfo?strategyCode='+strategyCode+'&backUri='+backUri},
		area:['750','550'],
		offset:['50px',''],
...
function addBrokerageStrategy(){
	window.location.href = '/device/divided/adddivided?backUri='+backUri;
}

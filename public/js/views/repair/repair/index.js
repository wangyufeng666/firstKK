        ...
        renderer : function(value, data, rowIndex, colIndex, metadata){
          ...
          if(data['ORDERSTATUS'] != 9 
            ...
            &&  data['ORDERSTATUS'] != 97
              ...
              returnText +='&nbsp;|&nbsp;<a href="javascript:void(0);" onclick="stopOrder(\''+data['ORDERNO']+'\')" class="a_link">终止</a>';
          }
          if(data['EXPRESSSTATUS'] == '2' || data['EXPRESSSTATUS'] == '3'){
              returnText +='&nbsp;|&nbsp;<a href="javascript:void(0);" onclick="sendback(\''+data['ORDERNO']+'\')" class="a_link">寄回</a>';
          }
          return returnText;
        }
      }

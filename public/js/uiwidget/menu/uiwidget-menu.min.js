...
setActiveItem:function(a,b){if(a!=this.activeItem){this.activeItem&&this.activeItem.deactivate();this.activeItem=a;a.activate(b)}else b&&a.expandMenu()},addMenuEvent:function(){var a=this;this.el.children("ul").mousedown(function(b){b.stopPropagation()}).click(function(b){var c=a.findTargetItem(b);if(c){c.handler&&c.handler(b,c);c.parentMenu&&c.parentMenu.hide(true)}}).mouseover(function(b){var c=a.findTargetItem(b);if(c)c.disabled||a.setActiveItem(c,true);a.over=true;a.triggerHandler("mouseover",
...
bind:function(a,b,c){typeof b==="object"?this.el.bind(a,b,c):this.el.bind(a,b)},trigger:function(a,b){this.el.trigger(a,b)},triggerHandler:function(a,b){this.el.triggerHandler(a,b)}};d.uiwidget.TextMenuItem=function(a,b){d.extend(this,b);this.init(a)};d.uiwidget.TextMenuItem.prototype={render:function(){var a=['<li itemId="',this.parentMenu.getItemId(this),'" class="uiwidget-menu-item ',this.menu?'uiwidget-menu-arrow">':'">'];this.icon&&a.push('<img class="uiwidget-menu-item-icon" border="0" align="absbottom"',

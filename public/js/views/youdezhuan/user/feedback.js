...
$().ready(function(){
	...
	grid = $('#grid').grid({
		...
		,cm:[
			...
			,{header:"联系方式", dataIndex:'CONTACT', width:'30px',sortable:false}
			,{header:"反馈内容", dataIndex:'INFORMDESC', width:'150px',sortable:false}
			,{header:"反馈时间", dataIndex:'CREATEDATE', width:'80px',sortable:false}
		]
		,url:'/youdezhuan/user/feedbacklist'

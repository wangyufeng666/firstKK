	...
	grid = $('#grid').grid({
		...
		,cm:[
			{header: "No.", dataIndex: 'id', width:'5%',sortable:false}
			  ,{header: "品台", dataIndex: 'platform_idname', width:'10%',sortable:false}
			  ,{header: "任务类型", dataIndex: 'type', width:'10%',sortable:false}
			  ,{header: "任务内容", dataIndex: 'name', width:'20%',sortable:false}
			  ,{header: "状态", dataIndex: 'status', width:'10%',sortable:false}
			  ,{header: "创建者", dataIndex: 'creator', width:'10%',sortable:false}
			  ,{header: "创建时间", dataIndex: 'creat_time', width:'10%',sortable:false}
		...
		,url : '/reptile/product/jobindexpage'
